...
const Secretary = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Secretary form:", formData);
    alert("ලේකම් තොරතුරු සම්පූර්ණ වාර්තාව යොමු කරන ලදි!");
  };

  return (
    <section className="chairman-wrapper">
      <div className="chairman-container">
        <h2 className="chairman-title">ලේකම් තොරතුරු / Secretary Details</h2>

        <p className="chairman-intro">
          මෙම අංශය <strong>ග්‍රාම සංවර්ධන සමිතියේ ලේකම්වරයා</strong>ගේ
